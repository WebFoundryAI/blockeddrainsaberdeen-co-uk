...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/aberdeen/" class="text-primary hover:underline">Aberdeen</a> and Aberdeenshire. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/aberdeen/" class="text-primary hover:underline">Aberdeen</a> and Aberdeenshire, including <a href="/locations/dyce/" class="text-primary hover:underline">Dyce</a>, <a href="/locations/westhill/" class="text-primary hover:underline">Westhill</a>, <a href="/locations/stonehaven/" class="text-primary hover:underline">Stonehaven</a>, Inverurie, Ellon, Peterhead, Portlethen, and Banchory. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
